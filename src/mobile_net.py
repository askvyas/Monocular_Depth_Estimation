# https://github.com/varun-affinsys/Monocular-Depth-Estimation-with-Transfer-Learning-pretrained-MobileNetV2/blob/master/train_mobilenetv2.ipynb
# this model is with reference to the above given link
# using Mobilenet v2 for Monocular depth estimation on NYU V2 dataset
# Mobilenet.py file from referenced github
